...
enum KMN_OPT {_tkmn_ = 0, _kppkmn_ = 1, _xbkmn_ = 2, _xtkmn_ = 3, _mnkmn_ = 4, _olkmn_ = 5, _rbkmn_, _rrkmn_, _lvq_, _hek_, _imk_, _hec_, _prc_, _pqc_, _rpkmn_};
...
protected:
    ...
    unsigned long count, clnumb;
    unsigned int nITER, ndim;
    unsigned int nThrd;
...
public:
    ...
    static double normVects(float *vects, double *lens, const unsigned int dim, const unsigned int n0);
    static   void normVects(const SparseMatrix &svects, double *lens, const unsigned int dim, const unsigned int n0);
