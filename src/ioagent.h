...
public:
    ...
    static unsigned int *loadKNNG(const char *srcFn,  unsigned int &row, unsigned int &dim);
    static unsigned int *loadKNNG1(const char *srcFn, unsigned int &row, unsigned int &dim);
    static void          mergKNNG(const char *knngFn1, const char *knngFn2, const char *dstKnng);
    ...
    static float *loadIMat(const char *srcfn, unsigned int &row, unsigned int &col);
    static float *loadDat(const char *srcfn,  unsigned int &row, unsigned int &col);
    ...
    ///write by pclin 2018-2-26
    static unsigned *loadgroundtruth(const char *gtdst,unsigned int &row,unsigned int &dim);
