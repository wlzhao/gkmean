...
RandomPartition::RandomPartition()
{
    ...
    this->_INIT_  = false;
    this->_REFER_ = false;
    this->distance = new DISTANCE::L2Distance<float>;
    this->kmMtd   = _rpkmn_;
    strcpy(mthStr, "_rpkmn_");
...
{
    int unsigned i, j, k, d, num, nlabel, clabel = 0;
    ...
    ///firstly whole dataset is into a cluster
    ...
    ///for each time. creating a cluster .
    while(nlabel < clnumb)
    {
        /**/
        if(!this->_REFINE_)
            this->gkmeanIter(clabel, nlabel);
        else
        ...
        ///in the beginning, clabel is 0, and cluster[0] is the whole dataset.so tmpcluster is the whole dataset.
...
int RandomPartition::randPartition(unsigned clabel, unsigned nlabel)
{
    unsigned i = 0, k = 0,  numb = 0;
    unsigned n1 = 0, n2 = 0, r = 0, v = 0, m1 = 0, m2 = 0;
    float val = 0, vmin = -1;
    vector<unsigned > crntClust = this->clusters[clabel];
    pair<float, unsigned> *vlmap = NULL;
    numb = crntClust.size();
    float vr = 0;
    bool iszero = true;
...
int RandomPartition::KDTree(unsigned clabel, unsigned nlabel)
{
    unsigned i = 0, k = 0,  numb = 0, n1 = 0;
    unsigned n2 = 0, r = 0, v = 0, m1 = 0, m2 = 0;
    float val = 0, vmin = -1;///RAND_MAX;
    vector<unsigned > crntClust = this->clusters[clabel];
    pair<float, unsigned> *vlmap = NULL;
    numb = crntClust.size();
    float vr = 0;
...
{
    unsigned i = 0, numb = 0, n1 = 0, n2 = 0, r = 0, v = 0;
    vector<unsigned > crntClust = this->clusters[clabel];
    pair<float, unsigned> *vlmap = NULL;
    numb = crntClust.size();
    float vr = 0;
